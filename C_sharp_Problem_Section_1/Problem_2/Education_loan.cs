...
namespace Problem_2
{
    ...
    {
        public Education_loan(double loan_amount, double interest_rate, double term_in_month)
        ...
        public override double Calculate_loan()
        {
            double rEducationLoan = interest_rate / 12 / 100;  // Monthly interest rate
             double nEducationLoan = term_in_month * 12;  // Total number of installments (months)
